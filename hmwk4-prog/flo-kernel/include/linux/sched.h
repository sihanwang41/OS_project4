...
struct sched_class {
	...
	void (*cgroup_attach) (struct task_struct *task);
...
/*
 * default timeslice for SCHED_GRR tasks is 100 msecs
 */
#define GRR_TIMESLICE		(100 * HZ / 1000)

/*
 * default rebalance interval for SCHED_GRR in msecs
 */
#define GRR_REBALANCE_INTERVAL	500
