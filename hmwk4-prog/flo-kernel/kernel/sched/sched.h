...
/* Group round-robin classes' related field in a runqueue: */
#ifdef CONFIG_SMP
#define FOREGROUND	1
#define BACKGROUND	2
#endif
...
struct rq {
	...
	unsigned long next_balance_grr;
...
extern void idle_balance_grr(int this_cpu, struct rq *this_rq);
...
extern void change_grr_rq_groups(int n);
extern void set_grr_rq_group(struct grr_rq *grr_rq, int cpu);
